...
const tableData = ref([
  {
    ...
    chartData: {
      nodes: [
        createNode('1', 1, '设计立项', '2026-12-31', [], 1, 1,'2026-12-31'),
        createNode('2', 4, '设计任务书', '', [], 1, 2),
        createNode('3', 4, '设计策划', '2026-12-31', [], 1, 3),
        createNode('4', 4, '设计交底', '', [], 1, 4),
        createNode('5', 0, '定制评审要素', '2026-12-31', [], 1, 5,'2026-12-31'),
  ...
  },
  {
    ...
    chartData: {
      nodes: [
        createNode('1', 1, '设计立项', '2026-12-31', [], 1, 1),
        createNode('2', 4, '设计任务书', '', [], 1, 2),
        createNode('3', 4, '设计策划', '2026-12-31', [], 1, 3),
        createNode('4', 4, '设计交底', '', [], 1, 4),
        createNode('5', 1, '定制评审要素', '2026-12-31', [], 1, 5),
        createNode('8', 1, '方案成果上传', '2026-12-31', [], 1, 6,'2026-12-31'),
        createNode('9', 1, '会签要点', '', [], 0, 6.5),
        createNode('10', 0, '方案成果确认', '', [], 1, 7),
        createNode('11', 0, '设计成果上传', '', [], 1, 8),
        createNode('12', 0, '会签要点', '', [], 0, 8.5),
        createNode('13', 0, '设计成果确认', '', [], 1, 9),
        createNode('14', 1, '施工图成果上传', '', [], 1, 10),
        createNode('15', 1, '会签要点', '', [], 0, 10.5),
        createNode('16', 1, '施工图成果确认', '', [], 1, 11),
        createNode('17', 0, '业务策略', '', [], 1, 12),
        createNode('18', 0, '招标图纸提供', '', [], 1, 13),
        createNode('19', 0, '施工图纸下发', '', [], 1, 14),
        createNode('20', 0, '深化图纸下发', '', [], 0, 14.5),
        createNode('21', 0, '专业线巡检', '', [], 1, 15),
        createNode('22', 0, '复盘总结', '', [], 1, 16),
        createNode('23', 0, '竣工图归档', '', [], 1, 17),
      ],
      links: [
        createLink('1', '2', '', 1),
        createLink('2', '3', '', 1),
  ...
  },
  {
    ...
    chartData: {
      nodes: [
        ...
        createNode('3', 4, '设计策划', '2026-12-31', [], 1, 3),
        createNode('4', 4, '设计交底', '', [], 1, 4),
        createNode('5', 0, '定制评审要素', '2026-12-31', [], 1, 5),
        createNode('6', 0, '概念成果上传', '', [], 1, 6),
        createNode('7', 0, '概念成果确认', '', [], 1, 7),
        createNode('8', 0, '方案成果上传', '', [], 1, 8),
        createNode('9', 0, '会签要点', '', [], 0, 8.5),
        ...
        createNode('12', 0, '会签要点', '', [], 0, 10.5),
        createNode('13', 0, '设计成果确认', '', [], 1, 11),
        createNode('14', 1, '施工图成果上传','2026-12-31', [], 1, 12 ,'2026-12-31'),
        createNode('15', 1, '会签要点', '', [], 0, 12.5),
        createNode('16', 1, '施工图成果确认', '', [], 1, 13),
        createNode('17', 0, '业务策略', '', [], 1, 14),
        createNode('18', 0, '招标图纸提供', '', [], 1, 15),
    ...
    <div class="chart-table">
      ...
      >
        ...
        <tiny-grid-column
          ...
          width="100"
        ></tiny-grid-column>
        <tiny-grid-column field="taskCode" title="任务编码">
